    ...
    return (
        ...
        <div className='flex'>
            ...
            <div className='absolute mt-12 lg:p-36 lg:mt-40 lg:ml-96  justify-center '>
                ...
                <p className='text-sm lg:text-2xl mx-10 text-center mt-5 tracking-widest text-white'>I am a full-time freelance designer from  <br /> I am specialized in VTuber Graphics.</p>
            </div>
        </div>
        </>
    );
